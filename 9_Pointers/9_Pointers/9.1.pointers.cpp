...
// It prints the length and width in ascending order (lowest to highest)
// BRIAN VAN VLYMEN
#include <iostream>
using namespace std;
int main()
{
	...
	area = (2 * (*lengthPtr + *widthPtr));// Fill in code to find the area by using only the pointer variables
